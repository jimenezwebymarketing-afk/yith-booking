...
function yith_wcbk_init() {
	...
	require_once YITH_WCBK_DIR . 'includes/traits/trait-yith-wcbk-draft-order-trait.php';
	...
	require_once YITH_WCBK_DIR . 'includes/class-yith-wcbk-reserved-bookings.php';
	require_once YITH_WCBK_DIR . 'includes/class-yith-wcbk-cron.php';
